-- Migration 0011: User Loans and Collateral
-- This script creates the missing tables in Supabase that were previously only in SQLite.
...
create table if not exists loan_collateral (
  ...
  source_id text not null, -- Can point to vesting_sources or others
