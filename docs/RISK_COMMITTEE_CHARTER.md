...
- **Founder/insider risk and flagging:** `docs/FOUNDER_INSIDER_RISK_AND_FLAGGING.md` — insider pump–dump risk, internal wallet–token relationship map (“bubble map”), flagging by wallet type and cohort, insider-aware LTV/caps; privacy preserved externally, full scrutiny internally.
