...
### Accrual
Interest compounds (rates: 5-15% APR, based on utilization/risk). For the on-chain rate model (utilization tiers, governance) and lending pool time/lifecycle, see `INTEREST_RATES_AND_POOL_LIFECYCLE.md`.
